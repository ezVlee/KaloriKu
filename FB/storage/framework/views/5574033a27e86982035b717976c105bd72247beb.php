<?php $__env->startSection('content'); ?>
    ...
    <div class="main-banner" id="top">
            <img src="<?php echo e(asset('assets/images/makanan-indo.jpg')); ?>" id="bg-video" />
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                ...
                <div class="main-button scroll-to-section">
                    <a href="<?php echo e(route('calorie')); ?>">Try Now</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="<?php echo e(asset('assets/imgs/home-images/line-dec.png')); ?>" alt="waves">
                ...
                <div class="col-lg-6">
                    <ul class="features-items">
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="<?php echo e(asset('assets/imgs/home-images/kcal.png')); ?>" alt="First One">
                            </div>
                            <div class="center-content">


                             <a href="<?php echo e(route('calorie')); ?>"">
                                ...
                                <a href="<?php echo e(route('calorie')); ?>" class="text-button">Discover App</a>
                            </div>
                        </li>
                    </ul>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\otw\laravel-fitness-main\resources\views/welcome.blade.php ENDPATH**/ ?>